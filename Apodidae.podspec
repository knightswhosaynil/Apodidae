#
# Be sure to run `pod lib lint Apodidae.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = "Apodidae"
  s.version          = "0.2.0"
  s.summary          = "Dependency Injection framework for Protocol Oriented Programming"
